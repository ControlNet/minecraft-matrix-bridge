...
public final class MatrixBridgeConfig {
    ...
    public static final ModConfigSpec.BooleanValue ENABLE_EVENT_TAPS;
    public static final ModConfigSpec.IntValue MAX_ACTIVE_EVENT_TAPS;
    public static final ModConfigSpec.IntValue DEFAULT_EVENT_THROTTLE_MS;
    public static final ModConfigSpec.IntValue EVENT_COMMAND_MIN_POWER_LEVEL;
    ...
    static {
        ...
        ENABLE_EVENT_TAPS = builder.comment("Enable event taps feature. When disabled, /matrix event commands are not available.")
                .define("enableEventTaps", true);
